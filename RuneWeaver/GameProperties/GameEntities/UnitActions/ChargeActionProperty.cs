...
namespace RuneWeaver.GameProperties.GameEntities.UnitActions
{
    ...
    /// </summary>
    class ChargeActionProperty : BasicActionProperty
    {
        /// <summary>
        ...
        public override void Execute()
        {
            ...
            TimeLeft = Distance / (MaxDistance * Force);
            Body.LinearVelocity = new Location((float)Math.Cos(Angle) * MaxDistance * Force, (float)Math.Sin(Angle) * MaxDistance * Force, 0);
            base.Execute();
        }
